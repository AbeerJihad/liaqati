async function getLatesMealPlan(rowMealPlan) {
    let url = "https://localhost:7108/api/MealPlanApi/LatesMealPlans";
    ...
    div.innerHTML = `
        ...
        <div class="position-relative">
            ...
            <img
                ...
                src="./Images/heart-svgrepo-com (1).png"
                alt=""
                srcset=""
            />
        </div>
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <div
                        style="background-color: #ffe9cb"
                        class="rounded-pill d-inline-block fw-bold align-middle p-2"
                    >
                        ${numsubscribers}
                    </div>
                </div>
                <div>
                    ...
                    <img
                        width="20"
                        src="./Images/cart-3-svgrepo-com.png"
                        alt=""
                        srcset=""
                    />
                </div>
