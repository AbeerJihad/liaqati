namespace liaqati_master.Data
{
    public static class Database
    {
        ...
        new Consultation() {
          ...
          new Consultation() {
            Id = "3", Title = "إمكانية أكل الحلويات والوجبات السريعة بكميات قليلة لمن يعالجون بالحمية الغذائية", UserId = "1", CategoryId = "14", PostDate = new DateTime(year: 2023, month: 3, 18),
          ...
          new Consultation() {
            Id = "4", Title = "ما هو الطعام الصحي للعمال الذين يعملون أعمالاً شاقة بشكل مستمر؟",UserId = "1", CategoryId = "14", PostDate = new DateTime(year: 2023, month: 2, 18),
