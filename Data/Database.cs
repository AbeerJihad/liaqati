namespace liaqati_master.Data
{
    public static class Database
    {
        ...
        public static List<Service> GetListOfOServies()
        {
            return new List<Service>()
            {
                ...
                new Service() {
                    ...
                    Id = "100", Title = " برنامج لنحت وتفصيل الجسم في 8 أسابيع فقط ", Price = 99, CategoryId = "3", Description=""
                }
        ...
        public static List<Exercise> GetListOfExercise()
        {
            ...
            {
             new Exercise(){Id="1" ,Title="",Price=100, BodyFocus="" , Detail="", Difficulty=1 , Duration=1},
            };
        }
        ...
        public static List<Exercies_program> GetListOfExerciesprogram()
        {
            ...
            {
             new Exercies_program(){Id="1",SportsProgramId="100" , ExerciseId="1" ,Day=1,Week=1},
            };
        }
